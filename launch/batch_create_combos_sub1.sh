...
roslaunch gait_hmm_ros create_data.launch prefix:=new_bags/ batch_train:=0 batch_test:=1 use_quat:=0 use_gyro:=1 use_accel:=0 use_com:=0 use_ir:=0 use_prox:=0 use_fsr:=0 \
rf:=chest_data_vec rul:=r_upper_arm_data_vec
roslaunch gait_hmm_ros create_data.launch prefix:=new_bags/ batch_train:=0 batch_test:=1 use_quat:=0 use_gyro:=1 use_accel:=0 use_com:=0 use_ir:=0 use_prox:=0 use_fsr:=0 \
rf:=chest_data_vec rll:=l_lower_leg_data_vec rul:=r_upper_arm_data_vec
roslaunch gait_hmm_ros create_data.launch prefix:=new_bags/ batch_train:=0 batch_test:=1 use_quat:=0 use_gyro:=1 use_accel:=0 use_com:=0 use_ir:=0 use_prox:=0 use_fsr:=0 \
rf:=chest_data_vec rll:=l_lower_leg_data_vec rul:=r_upper_arm_data_vec m:=r_lower_arm_data_vec
########################################################################################################################################################################
