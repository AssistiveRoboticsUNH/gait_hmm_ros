...
rosrun gait_hmm_ros create_single_classifier.py _folds:=10 _norm:=1 _prefix:=$1 _datafile:=gyro_bte_
...
rosrun gait_hmm_ros create_single_classifier.py _folds:=10 _norm:=1 _prefix:=$1 _datafile:=gyro_btr_bte_
######################################################################################################################