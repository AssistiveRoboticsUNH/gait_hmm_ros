...
roslaunch gait_hmm_ros create_data.launch prefix:=new_bags/ batch_train:=0 batch_test:=1 use_quat:=1 use_gyro:=0 use_accel:=0 use_com:=0 use_ir:=0 use_prox:=0 use_fsr:=0 \
rf:=r_shoulder_data_vec m:=temp1_data_vec
...
roslaunch gait_hmm_ros create_data.launch prefix:=new_bags/ batch_train:=0 batch_test:=1 use_quat:=1 use_gyro:=0 use_accel:=0 use_com:=0 use_ir:=0 use_prox:=0 use_fsr:=0 \
rf:=r_shoulder_data_vec m:=temp1_data_vec rll:=l_shoulder_data_vec
...
roslaunch gait_hmm_ros create_data.launch prefix:=new_bags/ batch_train:=0 batch_test:=1 use_quat:=1 use_gyro:=0 use_accel:=0 use_com:=0 use_ir:=0 use_prox:=0 use_fsr:=0 \
rf:=r_shoulder_data_vec m:=temp1_data_vec rll:=l_shoulder_data_vec rul:=l_upper_leg_data_vec
