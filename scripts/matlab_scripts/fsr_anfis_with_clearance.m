...
use_com, use_ir, use_prox, use_fsr, name, gran, k, mocap)
    ...
    if use_rf == 1
        ...
        c = c.rf;
        e = load('/home/lydakis-local/ros_ws/src/gait_hmm_ros/scripts/andreas4_rf.mat');
        e = e.rf;
    ...
    if use_rul == 1
        ...
        c = c.rul;
        e = load('/home/lydakis-local/ros_ws/src/gait_hmm_ros/scripts/andreas4_rul.mat');
        e = d.rul;
    ...
    if use_m == 1
        ...
        c = c.m;
        e = load('/home/lydakis-local/ros_ws/src/gait_hmm_ros/scripts/andreas4_m.mat');
        e = e.m;
    ...
    c = c.arduino;
    e = load('/home/lydakis-local/ros_ws/src/gait_hmm_ros/scripts/andreas4_arduino.mat');
    e = e.arduino;
